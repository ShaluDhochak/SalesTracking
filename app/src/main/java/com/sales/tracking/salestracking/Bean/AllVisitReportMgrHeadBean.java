...
public class AllVisitReportMgrHeadBean {

    public static class Visits_Report{
        String visit_code,meeting_dt,meeting_time,user_name,designation,purpose_name,visit_address,visit_comments,visit_status,lead_company;
        String lead_name;
    ...
    public ArrayList<Visits_Report> getVisits_report() {
        return visits_report;
    }

    public void setVisits_report(ArrayList<Visits_Report> visits_report) {
        this.visits_report = visits_report;
    }

    public ArrayList<Visits_Report> visits_report;
}
