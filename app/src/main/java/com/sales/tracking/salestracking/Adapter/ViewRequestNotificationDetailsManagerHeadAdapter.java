...
public class ViewRequestNotificationDetailsManagerHeadAdapter extends RecyclerView.Adapter<ViewRequestNotificationDetailsManagerHeadAdapter.MyViewHolder> {
    ...
    public ViewRequestNotificationDetailsManagerHeadAdapter(Context context,List<ManagerBean.clients> requestsList, ViewClientNotificationManagerFragment viewClientManagerFragment) {
    ...
    @Override
    public ViewRequestNotificationDetailsManagerHeadAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.customer_feedback_layout, parent, false);
        return new ViewRequestNotificationDetailsManagerHeadAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final ViewRequestNotificationDetailsManagerHeadAdapter.MyViewHolder holder, final int position) {
        ...
        holder.deleteCfClientCompanyName_iv.setVisibility(View.GONE);
