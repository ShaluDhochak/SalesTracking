...
public class VisitDoneReportManagerBean {

    public static class sp_Done_Visit{
    ...
    public ArrayList<sp_Done_Visit> getSp_done_visits() {
        return sp_done_visits;
    }

    public void setSp_done_visits(ArrayList<sp_Done_Visit> sp_done_visits) {
        this.sp_done_visits = sp_done_visits;
    }

    public ArrayList<sp_Done_Visit> sp_done_visits;
