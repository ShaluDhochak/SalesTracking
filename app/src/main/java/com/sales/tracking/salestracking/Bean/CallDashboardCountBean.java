...
public class CallDashboardCountBean {

    public static class Sp_Done_Calls{
        String service_id,service_person,service_contactno,service_status,service_createddt,service_comments,user_name,lead_company;
