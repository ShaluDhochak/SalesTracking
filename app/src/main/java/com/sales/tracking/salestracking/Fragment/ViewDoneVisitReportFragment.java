...
public class ViewDoneVisitReportFragment extends Fragment {
        ...
        if (!selectAssignTo.equals("Assign To")) {
            if (!(fromdateAdvanceSearchReportDetail_tv.getText().toString().equals(""))){
                if (!(todateAdvanceSearchReport_tv.getText().toString().equals(""))) {
                    getAllVisitDoneReportManagerRecyclerView();
                }else{
    ...
    private void getAllVisitDoneReportManagerRecyclerView(){
        if (Connectivity.isConnected(getActivity())) {
            ...
            GSONRequest<VisitDoneReportManagerBean> dashboardGsonRequest = new GSONRequest<VisitDoneReportManagerBean>(
                    Request.Method.POST,
                    Url,
                    VisitDoneReportManagerBean.class, map,
                    new com.android.volley.Response.Listener<VisitDoneReportManagerBean>() {
                        @Override
                        public void onResponse(VisitDoneReportManagerBean response) {
                            try{
    ...
    public void getAllVisitData(VisitDoneReportManagerBean.sp_Done_Visit bean){
