...
public class ViewTotalExpensesManagerAdapter extends RecyclerView.Adapter<ViewTotalExpensesManagerAdapter.MyViewHolder> {
    private List<ExpencesSpBean.Manager_Expenses> tasksList;
    ...
    public ViewTotalExpensesManagerAdapter(Context context, List<ExpencesSpBean.Manager_Expenses> tasksList, ViewTotalExpensesFragment viewTotalExpensesFragment) {
    ...
    @Override
    public ViewTotalExpensesManagerAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.view_collection_list, parent, false);
        return new ViewTotalExpensesManagerAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final ViewTotalExpensesManagerAdapter.MyViewHolder holder, final int position) {
        ExpencesSpBean.Manager_Expenses bean = tasksList.get(position);
        ...
        holder.deleteCollection_iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                viewTotalExpensesFragment.getExpensesManagerDeleteData(tasksList.get(position));
            }
        });
