...
public class ViewCollectionReportAdapter extends RecyclerView.Adapter<ViewCollectionReportAdapter.MyViewHolder> {
    ...
    public ViewCollectionReportAdapter(Context context, List<CollectionListBean.Collections> tasksList, ViewCollectionReportFragment viewTotalCollectionFragment) {
